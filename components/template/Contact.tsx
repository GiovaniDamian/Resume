...
export default function Contact(props: any) {
    ...
    return <>
        <div id="contact" className='bg-mainBlueDark flex flex-col justify-center content-center text-center text-mainBlueLight h-full p-4'>
            ...
            <div>
                <a href={language == 'pt' ? "https://drive.google.com/file/d/1EmCdejd9a3DqsICcWlLAZHmp0OC106ta/view?usp=drive_link" : "https://drive.google.com/file/d/1qkYlgbS7di7WGquIgsuP-I2xYOXgXQVb/view?usp=sharing"} target="_blank">
