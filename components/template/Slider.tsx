...
export default function Slider() {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="w-full flex flex-col items-center justify-center transition-transform ease-in-out duration-500 rounded-2xl">
                ...
                {projects.map((project, index) => (
                    <motion.div
                        ...
                        style={{ width: "40%", position: 'relative', height: project.id === 4 ? '300px' : '400px' }}
